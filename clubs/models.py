...
class Groupresults(models.Model):
    result_id=models.AutoField
    result_name=models.CharField(max_length=50, default="")
    result_category = models.CharField(max_length=50, default="")
    result_desc=models.CharField(max_length=300, default="")
    result_image= models.ImageField(upload_to="clubs/images",null=True, blank=True)
    result_date = models.DateTimeField(null=True)
    result_document= models.FileField(upload_to="clubs/documents",null=True, blank=True)
